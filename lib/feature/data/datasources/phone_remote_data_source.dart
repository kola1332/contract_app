...
class PhoneRemoteDataSourceImpl implements PhoneRemoteDataSource {
  ...
  // @override
  // Future<List<PhoneHSModel>> getPhonesHS() async {
  ...
  // @override
  // Future<List<PhoneBSModel>> getPhonesBS() async {
  //   final response = await client.get(
  //     Uri.parse('https://run.mocky.io/v3/654bd15e-b121-49ba-a588-960956b15175'),
  //     // headers: {'Content-Type': 'application/json'}
  //   );
  ...
  //         .map((phone) => PhoneBSModel.fromJson(phone))
  //         .toList();
  //   } else {
  //     throw ServerException();
  //   }
...
//   Future<List<PhoneHomeStoreModel>> call() async {
//     final response = await client.get(
//         Uri.parse(
//             'https://run.mocky.io/v3/654bd15e-b121-49ba-a588-960956b15175'),
//         headers: {'Content-Type': 'application/json'});
